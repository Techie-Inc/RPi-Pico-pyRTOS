#main.py will run on the Raspberry Pi Pico at boot if entire project is copied to the device.
#To run a different script at boot, rename that script to main.py and place in root directory.
